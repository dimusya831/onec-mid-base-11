...
Процедура ДополнитьФорму(Форма) Экспорт
	...
	Если ИмяФормы = "Документ.ЗаказПокупателя.Форма.ФормаДокумента" Тогда
		...
		ДобавитьКоэффициентСкидкиИКомандаПересчет(Форма);
...
Процедура ДобавитьКоэффициентСкидкиИКомандаПересчет(Форма)
	ДобавляемыеРеквизиты = Новый Массив;
	РеквизитКонтактноеЛицо = Новый РеквизитФормы("КоэффициентСкидки",Новый ОписаниеТипов("Число",Новый КвалификаторыЧисла(100,0)));
	
	ДобавляемыеРеквизиты.Добавить(РеквизитКонтактноеЛицо);
	Форма.ИзменитьРеквизиты(ДобавляемыеРеквизиты);

	
	ПолеВвода = Форма.Элементы.Добавить("КоэффициентСкидки",Тип("ПолеФормы") , Форма.Элементы.ГруппаШапкаЛево);
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПутьКДанным = "КоэффициентСкидки";
	ПолеВвода.УстановитьДействие("ПриИзменении" ,"КоэффициентСкидкиПриИзминении" );
